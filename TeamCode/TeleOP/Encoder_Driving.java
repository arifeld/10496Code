        ...
        if (gamepad1.right_stick_x == 0){
            if (gamepad1.right_bumper){ // For testing purposes
                ...
                while (gamepad1.right_bumper){
                    ...
                    double topLeftPower =  -driveAxial - driveLateral - (k * updatedRotation); // Top left motor.
                    double topRightPower =  driveAxial - driveLateral + (k * updatedRotation); // Top right motor.
                    double backLeftPower =  driveAxial + driveLateral - (k * updatedRotation); // Bottom left motor.
                    double backRightPower = driveAxial + driveLateral + (k * updatedRotation); // Bottom right power.
